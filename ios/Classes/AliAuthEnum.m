...
+ (NSDictionary *)keyPair {
  return @{
    ...
    @"privacyAlertBtnTextColor": @"privacyAlertButtonTextColors",
    @"privacyAlertContentColor": @"privacyAlertContentColors",
    @"privacyAlertContentAlignment": @"privacyAlertContentAlignment",
